...
from fs3d.ops import PointFPModule, build_sa_module
...
class PointNet2SASSG(BasePointNet):
    ...
    def __init__(self,
        ...
        for sa_index in range(self.num_sa):
            ...
            #####
            # self.PR_modules.append(TransformerLayer(
            #     d_model=sa_in_channel,
            #     nhead=4,
            #     dropout=0.1,
            # ))
    ...
    def forward(self, points):
        ...
        for i in range(self.num_sa):
            ...
            ####
            # cur_features = self.PR_modules[i](cur_features, xyz=cur_xyz)[0]
        ...
        # print("ret: " + str(ret['fp_features'][-1].shape))
