...
from fs3d.core import Box3DMode, Coord3DMode, show_result
...
class Base3DDetector(BaseDetector):
    ...
    def forward_test(self, points, img_metas, pts_semantic_mask=[None],
                      pts_instance_mask=[None], img=None, **kwargs):
        """
        Args:
        ...
        if num_augs == 1:
            ...
            # if pts_instance_mask == None:

            return self.simple_test(points[0], img_metas[0], pts_semantic_mask[0],
                      pts_instance_mask[0], img[0], **kwargs)
        else:
