...
def test_chamfer_disrance():
    from fs3d.models.losses import ChamferDistance, chamfer_distance
...
def test_paconv_regularization_loss():
    from fs3d.models.losses import PAConvRegularizationLoss
    from fs3d.ops import PAConv, PAConvCUDA
