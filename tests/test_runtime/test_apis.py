...
from fs3d.apis import (convert_SyncBN, inference_detector,
                          inference_mono_3d_detector,
                          inference_multi_modality_detector,
                          inference_segmentor, init_model, show_result_meshlab,
                          single_gpu_test)
from fs3d.core import Box3DMode
from fs3d.core.bbox import (CameraInstance3DBoxes, DepthInstance3DBoxes,
                               LiDARInstance3DBoxes)
from fs3d.datasets import build_dataloader, build_dataset
...
def _get_config_directory():
    ...
    try:
        ...
        import fs3d
        repo_dpath = dirname(dirname(fs3d.__file__))
