...
def test_camera_to_lidar():
    from fs3d.core.bbox.box_np_ops import camera_to_lidar
...
def test_box_camera_to_lidar():
    from fs3d.core.bbox.box_np_ops import box_camera_to_lidar
...
def test_corners_nd():
    from fs3d.core.bbox.box_np_ops import corners_nd
...
def test_center_to_corner_box2d():
    from fs3d.core.bbox.box_np_ops import center_to_corner_box2d
...
def test_rotation_2d():
    from fs3d.core.bbox.box_np_ops import rotation_2d
    angles = np.array([-3.14])
