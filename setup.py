...
def add_mim_extention():
    ...
    mim_path = osp.join(repo_path, 'fs3d', '.mim')
    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                ...
                module='fs3d.ops.roiaware_pool3d',
                sources=[
